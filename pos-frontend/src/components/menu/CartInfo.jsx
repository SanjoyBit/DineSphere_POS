...
const CartInfo = () => {
  ...
  return (
    <div className="px-4 py-2">
      ...
      <div className="mt-4 overflow-y-scroll scrollbar-hide h-[250px]" ref={scrolLRef} >
        {cartData.length === 0 ? (
          <p className="text-[#ababab] text-xs flex justify-center items-center h-[250px]">Your cart is empty. Start adding items!</p>
        ) : cartData.map((item) => {
          return (

...
export const menus = 
  [
    { id: 1, name: "Starters", bgColor: "#e67e00", icon: "🍲", items: startersItem }, // Darker Orange for starters
  { id: 2, name: "Main Course", bgColor: "#4a0072", icon: "🍛", items: mainCourse }, // Darker Indigo for main course
  { id: 3, name: "Beverages", bgColor: "#0066cc", icon: "🍹", items: beverages }, // Darker Blue for beverages
  { id: 4, name: "Soups", bgColor: "#e64a19", icon: "🍜", items: soups }, // Darker Tomato Red for soups
  { id: 5, name: "Desserts", bgColor: "#db4b9d", icon: "🍰", items: desserts }, // Darker Pink for desserts
  { id: 6, name: "Pizzas", bgColor: "#a15a2f", icon: "🍕", items: pizzas }, // Darker Brown for pizzas
  { id: 7, name: "Alcoholic Drinks", bgColor: "#5f3b1f", icon: "🍺", items: alcoholicDrinks }, // Darker Saddle Brown for alcoholic drinks
  { id: 8, name: "Salads", bgColor: "#068c1f", icon: "🥗", items: salads },
  ]
